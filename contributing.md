...
- Add entries in **alphabetical order** within their section. Exceptions: *Tutorials & Deep Dives*, *Articles*, and *Talks & Videos* go newest first.
...
- Wishlist ideas live in [wishlist.md](wishlist.md). Before adding one, check [Batteries Included](README.md#batteries-included) - much of what a Clojure or PHP developer expects from a library already ships with the compiler.
